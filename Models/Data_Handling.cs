...
namespace AngelDLP
{
    public static class Data_Handling
    {
        public static byte[] bitTObyte(byte[] output, int num)
        {
        ...
        public static byte[] byteTObit(byte[] inputB, int num)
        {
        ...
        public static short[] byteTOshort(byte[] Byte, int num)
        {
        ...
        public static byte[] shortTObyte(short[] Short1, int num)
        {
        ...
        public static int[] byteTOint(byte[] Byte, int num)
        {
        ...
        public static int[] byteTOint_htol(byte[] Byte, int num)
        {
            int[] int1 = new int[num];
            int j;
            for (j = 0; j < num; j++)
        ...
        public static byte[] intTObyte(int[] int1, int num)
        {
            int i;
        ...
        public static float[] byteTOfloat(byte[] Byte, int num)
        {
        ...
        public static byte[] floatTObyte(float[] float1, int num)
        {
        ...
        public static void highTolow(byte[] byte1, int num)
        {
            int HTOL;
        ...
        public static short highTolow_W(short Short1)
        {
            Byte BYTE1 = 0;
            Byte BYTE2 = 0;
            BYTE2 = (byte)(Short1 >> 8);
        ...
        public static int highTolow_D(int INT)
        {
        ...
        public static float highTolow_F(float Float)
        {
            byte[] Byte1 = new byte[4];
            byte[] Byte2 = new byte[4];
